...
<!-- 	<div class="choose-menu-custom">
	...
	<div class="c-col-1">
		<input id="carsearch-homepage" class="custom-input" type="text" placeholder="Enter a Make, Model & Year">
    	<img src="https://autogenie.co.uk/wp-content/uploads/2022/02/search-icon.svg" class="search-icon-field" data-toggle="modal" data-target="#searchModal">
	</div>
<!-- 	<button type="submit" class="search-btn hide-mobile" id="car-search-btn">Search</button> -->
</div>
